...
public class TrelloClientTest {
    ...
    @Before
    public void init() {
        when(trelloConfig.getTrelloUsername()).thenReturn("pratajski");
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/pratajski/boards?key=test&token=test&fields=name,id&lists=all");
